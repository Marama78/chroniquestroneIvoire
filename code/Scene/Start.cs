      ...
      private void SetCommands()
        {
            ...
            commands = new TE_Button[3];

            for (int i = 0; i < 3; i++)
            {
                int posX = -76 + panelCMDOffset.x;
                int posY = -22 + panelCMDOffset.y + i * 18;
        ...
        public override void Load(ref ContentManager _content)
        {
            ...
            panel = _content.Load<Texture2D>("Tilesets\\UIwindow");
                ...
                if (commands[i].IsCollide(mouseposition))
                {
                    ...
                    if(isclicked)
                    {
                        ...
                        switch(i)
                        {
                                ...
                                case 2: isLOCKED = true; nextscene = scene.quit; break;
                        }
                    }
                }
                else
